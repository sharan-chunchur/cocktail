...
DrinkDetailsResponse _$DrinkDetailsResponseFromJson(
    ...
    DrinkDetailsResponse(
      drinks: (json['drinks'] as List<dynamic>)
          .map((e) => DrinkDetail.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
...
DrinkDetail _$DrinkDetailFromJson(Map<String, dynamic> json) => DrinkDetail(
...
Map<String, dynamic> _$DrinkDetailToJson(DrinkDetail instance) =>
    <String, dynamic>{
